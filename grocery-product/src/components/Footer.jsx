...
const Footer = () => {
  ...
  return (
    <div className="px-6 mt-[20vh] md:px-16 lg:px-24 xl:px-32 bg-[#EAF6F0]">
            ...
            <p className="py-4 text-center text-2xl md:text-base text-gray-900">
                Copyright 2026 © Sagarsingh.div All Right Reserved.
            </p>
        </div>
  );
};
